...
The sections will also appear in the TOC, functions contained in it be nested here as well.  
...
This annotation can be used to disable the grouping again for the following functions. Has no effect on its own.
...
Create a link on the given function in the "See Also" section of a function or block generated by `@section`.
